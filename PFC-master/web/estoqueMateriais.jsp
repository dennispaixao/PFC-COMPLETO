...
<html>
    ...
    <body>
          ...
          <div class="row">
              <div class="col">        
                    ...
                    <div class="form-group row">
                         <h1  class="col-12">Estoque de matérias primas</h1>           
                    </div>  
                   <form>
                       ...
                       <table class="table  text-dark" style="font-weight:bold; font-size: 20px; background:#bcbcbc; "border="l">    
        ...
        <script src="src/js/ListarEstoqueMateriais.js"></script>    
