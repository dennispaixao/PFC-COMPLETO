...
const btnAlterarProduto = document.querySelector("#alterarProduto");
...
btnAlterarProduto.addEventListener("click",()=>{
   ...
   request.open('POST', 'AlterarProdutoAjax?itens='+strItens+","+nome+","+descricao+","+preco+","+peso+","+largura+","+altura+","+espessura+","+id);
   request.send();  
