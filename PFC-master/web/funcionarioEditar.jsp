...
<html>
    ...
    <body>
      <%@include file="/menu.jsp" %>    
       ...
       <% 
           Funcionario p = (Funcionario) request.getAttribute("funcionario");

       %>

       <div id="box-form" >
            <h1>Editar cadastro de funcionario</h1>
        ...
        <form action="ControllerFactory" method="post">
             ...
             <a href="ControllerFactory?acao=ListarFuncionario" style="margin-right: 20px"  > voltar </a>
            <input type="submit" name="acao" value="Salvar Funcionario">
         </form>
