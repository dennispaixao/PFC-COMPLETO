    ...
    <body>
       ...
       <div id="box-form" >
           ...
           <form action="ControllerFactory" method="post">
               ...
               Nome: <input type="text" name="nome" style="width:200px"><br>
               Sobrenome: <input type="text" name="sobrenome"><br><br>
               Sexo:  
               Feminino<input type="radio" name="sexo" value="f">
               Masculino<input type="radio" name="sexo" value="m" checked="checked"><br>
               Rg: <input type="text" name="rg" style="width:200px"><br>
               Cpf: <input type="text" name="cpf"><br>
               Email: <input type="text" name="email"><br>
               Telefone: <input type="text" name="telefone"><br>
               Celular: <input type="text" name="celular"><br>
   
               <input type="submit" name="acao" value="Cadastrar Cliente">
               <input type="submit" name="acao" value="Listar Cliente">
